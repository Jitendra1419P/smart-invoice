...
const BankAccount = require("./smart-invoice-backend/models/BankAccount");
const BankTransaction = require("./smart-invoice-backend/models/BankTransaction");
const Invoice = require("./smart-invoice-backend/models/Invoice");
